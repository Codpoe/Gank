...
public class PicturePresenter implements PictureContract.Presenter {
    ...
    public void sharePic(Uri uri) {
        ...
        mContext.startActivity(Intent.createChooser(intent, mContext.getResources().getString(R.string.share_pic)));
    }
    ...
    public void copyUrl(String url) {
        ...
        mView.showSuccess(mContext.getResources().getString(R.string.copy_success));
    }
